...
public class HomeController extends BaseController {
    ...
    private enum HomeDemoModel {
        SIMPLE_SHARED_ELEMENT_TRANSITION("Simple Shared Element Demo", R.color.lime_300),
    ...
    void onModelRowClick(HomeDemoModel model, int position) {
        switch (model) {
            case SIMPLE_SHARED_ELEMENT_TRANSITION:
                getRouter().pushController(RouterTransaction.with(new StartSharedElementController(new Bundle()))
